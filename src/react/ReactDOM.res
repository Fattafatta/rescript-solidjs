...
type style = JsxDOM.style
type domRef = JsxDOM.domRef
type classList = JsxDOM.classList
...
module Props = {
  ...
  /* * DEPRECATED */
  @deriving(abstract) @deprecated("Please use type ReactDOM.domProps")
  type props = {
    @optional
    key: string,
    @optional
...
external jsx: (string, JsxDOM.domProps) => Jsx.element = "JsxRuntime.jsx"

external jsxKeyed: (string, JsxDOM.domProps, ~key: string=?, @ignore unit) => Jsx.element =
  "JsxRuntime.jsx"

external jsxs: (string, JsxDOM.domProps) => Jsx.element = "JsxRuntime.jsx"
